...
void main() async {
  ...
  Stripe.publishableKey = 'pk_test_51PJ6WBRpJ9NLbNQlzmluuRCaZG1LTxjCpFq2FqEr9udBzzVcS1zeasIER2SjTSaUBtNhaz0B6yiqU7DTTAaKaUPX00ONNPoAQU';
...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: ChatBot(), // Use the HomePage widget as the home page
    );
  }
